...
fixtures = 'http://www.betexplorer.com/soccer/norway/eliteserien/fixtures/'
day_matches_no = 9
...
matches_rows = get_rows(fixtures)



matches_rows = map_rows(matches_rows, 'fixtures')
